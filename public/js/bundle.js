...
var displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Branch ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map);
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " registered successfully!"));
          }
          _context.next = 10;
          break;
        case 7:
...
var bookRestaurant = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(restaurantId) {
    var session;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return (0, _axios.default)("/api/v1/bookings/checkout-session/".concat(restaurantId));
        case 3:
  ...
  return function bookRestaurant(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
var bookBtn = document.getElementById('book-restaurant');
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          e.preventDefault();
          document.querySelector('.btn--register').textContent = 'Registering...';
          ...
          //   'register'
          // );
          document.querySelector('.btn--register').textContent = 'Register new user';
...
if (bookBtn) bookBtn.addEventListener('click', function (e) {
  ...
  var restaurantId = e.target.dataset.restaurantId;
  (0, _stripe.bookRestaurant)(restaurantId);
});
